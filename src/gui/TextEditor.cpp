...
void TextEditor::Render(const char* aTitle, const ImVec2& aSize, bool aBorder)
{
    ...
    if(m_customFont) ImGui::PushFont(m_customFont);
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::HLSL()
{
    ...
    if (!inited)
    {
        ...
        static const char* const identifiers[] = {
                ...
                "GetRenderTargetSamplePosition", "GroupmguimoryBarrier", "GroupmguimoryBarrierWithGroupSync", "InterlockedAdd", "InterlockedAnd", "InterlockedCompareExchange",
...
void TextEditor::SetCustomFont(ImFont *font)
{
    m_customFont = font;
}