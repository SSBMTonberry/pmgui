...
#ifndef PMGUI_SELECTABLE_H
#define PMGUI_SELECTABLE_H
...
namespace pmgui
{
    class Selectable : public Control
    {
        ...
        public:
            ...
            Selectable(const std::string &id, const std::string &label, std::optional<pmgui::Image> image = std::nullopt);
            Selectable(const std::string &id, const std::string &label, pmgui::Image *image);
            Selectable(const std::string &id, const std::string &label, const sf::Vector2<int> &size, std::optional<pmgui::Image> image = std::nullopt);
        ...
        protected:
            ...
            std::optional<pmgui::Image> m_image = std::nullopt;
