...
pmgui::ColorPicker::ColorPicker(const std::string &id, const std::string &label, const ColorPickerType &pickerType,
...
bool pmgui::ColorPicker::process()
{
...
bool pmgui::ColorPicker::processByPickerType()
{
    switch (m_pickerType)
    {
...
const sf::Color &pmgui::ColorPicker::getColor() const
{
    return m_color;
}

void pmgui::ColorPicker::setColor(const sf::Color &color)
{
