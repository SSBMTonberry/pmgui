...
void pmgui::MessagePopup::initialize()
{
...
void pmgui::MessagePopup::addReferences()
{
...
void pmgui::MessagePopup::setMessage(const std::string &msg)
{
    m_message = msg;
...
void pmgui::MessagePopup::initializeButtons()
{
...
void pmgui::MessagePopup::onButtonPress(Button *btn, const std::string &command)
{
...
pmgui::MessagePopupResponse pmgui::MessagePopup::getLastResponse() const
{
    return m_lastResponse;
}

void pmgui::MessagePopup::registerOnMsgResponseCallback(const pmgui::MessagePopup::func_msg_response &cb)
{
    m_callbackOnMsgResponse.emplace_back(cb);
}

void pmgui::MessagePopup::clearCallbacks()
{
    m_callbackOnMsgResponse.clear();
}

void pmgui::MessagePopup::changePopupType(const pmgui::MessagePopupType &popupType)
{
    m_messagePopupType = popupType;
    initializeButtons();
}
 ...
 */
void pmgui::MessagePopup::refresh()
{
    initialize();
}
 ...
 * @param btn3Visible
 */
void pmgui::MessagePopup::setCustomButtonVisibility(bool btn1Visible, bool btn2Visible, bool btn3Visible)
{
 ...
 */
size_t pmgui::MessagePopup::getNumberOfButtons()
{
    size_t buttons = 0;
