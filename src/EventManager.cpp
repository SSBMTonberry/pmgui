...
pmgui::EventManager::EventManager(sf::RenderWindow *renderWindow)
{
 ...
 * @param renderWindow
 */
void pmgui::EventManager::initialize(sf::RenderWindow *renderWindow)
{
    m_window = renderWindow;
}

pmgui::EventManager::~EventManager()
{

}


void pmgui::EventManager::update()
{
    fillEventList();
    manageKeyReleased();
...
std::vector<sf::Event> pmgui::EventManager::getEvents(const sf::Event::EventType &eventType)
{
...
bool pmgui::EventManager::isKeyPressed(const sf::Keyboard::Key &key)
{
...
bool pmgui::EventManager::isKeyDown(const sf::Keyboard::Key &key)
{
    //std::vector<sf::Event> * keysPressed = getEvents(sf::Event::KeyPressed);
    //std::vector<sf::Event> keyPresses = from(*keysPressed) >> where([&key](sf::Event evt) { return (evt.key.code == key); }) >> to_vector();
...
bool pmgui::EventManager::isKeyReleased(const sf::Keyboard::Key &key)
{
...
void pmgui::EventManager::fillEventList()
{
    m_events.clear();
    sf::Event event;
...
void pmgui::EventManager::manageKeyReleased()
{
...
std::vector<sf::Event> &pmgui::EventManager::getAllEvents()
{
    return m_events;
}
